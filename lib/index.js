...
export function apply(ctx) {
    ...
    const harness = ctx.get ? ctx.get('harness') : ctx.harness;
    if (harness && typeof harness.handle === 'function') {
        ...
        harness.handle('prompt-studio:run-eval', async (args) => {
            ...
            const agentService = ctx.get ? ctx.get('agent') : undefined;
